...
<a href="<?php echo $path; ?>" title="<?php echo EMPRESA; ?>" id="logo"><img src="<?php echo $path; ?>imagenes/logo.png" alt="<?php echo EMPRESA; ?>"></a>
<a href="http://www.geckocancuntours.com/en/" title="<?php echo IDIOMA; ?>" id="idioma"><span class="<?php echo BANDERA; ?>"><?php echo IDIOMA; ?></span></a>
...
<ul class="menu">
  <li><a href="<?php echo $path; ?>"<?php if ($page == 'index.php') {?> class="activo"<?php } ?>><?php echo NAVINICIO; ?></a></li>
  <li><a href="<?php echo $path; ?>nosotros.php"><?php echo NAVNOSOTROS; ?></a></li>
  <li><a href="<?php echo $path; ?>contacto.php" <?php if ($page == 'contacto.php') {?> class="activo" <?php } ?>><?php echo NAVCONTACTO; ?></a></li>
</ul>
<nav>
<ul>
