...
$Nlistings = mysql_query($query_Nlistings, $conexion) or die(mysql_error());
$row_Nlistings = mysql_fetch_assoc($Nlistings);
$totalRows_Nlistings = mysql_num_rows($Nlistings);
	 echo "($totalRows_Nlistings Tours)";
	 ?>&nbsp;</td>
      <td><img src="images/modificar.gif" width="22" height="22" alt="Editar" /></td>
      </tr>
    <?php } while ($row_localizacion = mysql_fetch_assoc($localizacion)); ?>
</table>
