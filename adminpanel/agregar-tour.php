...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $id_tour = mysqli_insert_id( $conexion ); 
...
?>
	...
	<!-- Precios -->
	<tr valign="baseline">
	  <td colspan="2"  background="images/top-menubg.gif"><b>Precios</b> <i class="row1">(No utilice comas, espacios o signos de puntuación)</i></td>
	</tr>
	<tr valign="baseline">
		<td><strong>Precios por zona:</strong> Cancun (Default), RM y Playa Mujeres</td>
	</tr>
	<tr valign="baseline">
		<td bgcolor="#F3F3F3">Precio adulto</td>
		<td>
			<input name="precio_adulto" id="precio_adulto" type="text" value="" size="10" maxlength="20" />
			<input name="precio_adulto" id="precio_adulto" type="text" value="" size="10" maxlength="20" />
			<input name="precio_adulto" id="precio_adulto" type="text" value="" size="10" maxlength="20" />
		</td>
	</tr>
	<tr valign="baseline">
		...
		<td>
			<input name="precio_nino" id="precio_nino" type="text" value="" size="10" maxlength="20" />
			<input name="precio_nino" id="precio_nino" type="text" value="" size="10" maxlength="20" />
			<input name="precio_nino" id="precio_nino" type="text" value="" size="10" maxlength="20" />
		</td>
	</tr>
	<tr>
		<td><i class="row1">(Si no hay precios por zona definidos, el tour automaticamente tomara el precio de Cancún como default)</i></td>
	</tr>
