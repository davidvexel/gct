...
$colname_busqueda = "-1";
if (isset($_GET['nombre_propiedad'])) {
  $colname_busqueda = $_GET['nombre_propiedad'];
}
mysql_select_db($database_conexion, $conexion);
$query_busqueda = "SELECT T.id_tour, T.nom_tour, T.imagen, L.nom_localizacion, C.nom_cat FROM tours AS T INNER JOIN localizacion AS L ON (T.localizacion_id = L.id_localizacion) INNER JOIN  categorias AS C ON (T.cat_id = C.id_cat) WHERE  T.nom_tour LIKE '%$colname_busqueda%' ORDER BY T.id_tour";
...
<td valign="top"> 
<h2 align="center">Buscar tours por nombre</h2> 
