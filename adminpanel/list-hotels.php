...
<?php
	...
	$query_hoteles = "SELECT * FROM hoteles ORDER BY id ASC";
	
	$hoteles = mysqli_query( $conexion, $query_hoteles ) or die( mysqli_error( $conexion ) );
	
	$row_hoteles = mysqli_fetch_assoc( $hoteles );
	
	$total_rows_hoteles = mysqli_num_rows( $hoteles );
?>
													...
													<td colspan="4">
															<table width="900" align="center" cellpadding="0" cellspacing="0">
																<tr>
																		...
																		<td valign="top">
																			<h2 align="center">Lista de Hoteles</h2>
																			<h4 align="center">Agregar nuevo</h3>

																			<table align="center">
																				<form method="POST" name="new_hotel">
																				<tr>
																					<td><input type="text" name="hotel" placeholder="Nombre del Hotel" /></td>
																					<td>
																						<select name="zona" id="">
																			...
																			<table width="400" border="0" align="center" cellpadding="5" cellspacing="1">
																					<tr>
																						...
																						<td background="images/top-menubg.gif"><b>Hotel</b></td>
																					...
																					<tr <?php if ($fila++%2!=0) echo "bgcolor=\"#F3F3F3\"";?>>
																						<td><?php echo $row_hoteles['id']; ?></td>
																						<td>
																							<?php echo $row_hoteles['nombre']; ?>
																							
																						</td>
																						<td>
																							<?php echo $row_hoteles['zona']; ?>
																						</td>
																						<td><img src="images/modificar.gif" width="22" height="22" alt="Editar" /></td>
																					</tr>
																					<?php } while ( $row_hoteles = mysqli_fetch_assoc( $hoteles ) ); ?>
																			</table>
																		</td>
																</tr>
															</table>
