...
$UsuarioPass = mysql_query($query_UsuarioPass, $conexion) or die(mysql_error());
$row_UsuarioPass = mysql_fetch_assoc($UsuarioPass);
$totalRows_UsuarioPass = mysql_num_rows($UsuarioPass);
?>
