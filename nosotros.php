...
<img class="imagen radius mbottom" src="<?php echo $path; ?>timthumb.php?src=<?php echo $path; ?>imagenes/nosotros.jpg&w=700&h=300&zc=1&q=90" alt="Nosotros" title="Nosotros">
<div class="clear"></div>
