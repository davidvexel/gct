...
$Utours = mysql_query($query_Utours, $conexion) or die(mysql_error());
while ($row_Utours = mysql_fetch_assoc($Utours)){
	array_push($arrUtours, $row_Utours);
	}

$arrSliders =array();
$selectSliders = "SELECT * FROM slider WHERE idiomaSlider = 'Ing' AND activoSlider = 'SI' ORDER BY RAND() LIMIT 3";
$querySliders = mysql_query($selectSliders, $conexion) or die(mysql_error());
$totalSliders = mysql_num_rows($querySliders);

while($rowSliders = mysql_fetch_assoc($querySliders)){
...
<script src="<?php echo $pathHost; ?>js/modernizr.custom.js"></script>
</head>
<body>
<div id="wrapper">
<div class="container">
...
<a href="<?php echo $path; ?>en/detalles/<?php echo $row_Utours['id_tour']."-".urls_amigables($nom_tour).".php"; ?>" title=""><span class="over">&nbsp;</span><img src="<?php echo $path; ?>timthumb.php?src=<?php echo $pathImagen.$row_Utours['imagen']; ?>&amp;w=160&amp;h=120&amp;zc=1&amp;q=90" alt="" title="" class="imagen"></a>
</figure><!--fin figure.three.columns-->
<div class="datosTour seven columns">
<h3 class="nomTour"><a class="ax" href="<?php echo $path; ?>en/detalles/<?php echo $row_Utours['id_tour']."-".urls_amigables($nom_tour).".php"; ?>"><?php echo $row_Utours['nom_tour'.$idiomaDB]; ?></a></h3>
...
<a href="<?php echo $path; ?>en/detalles/<?php echo $row_Utours['id_tour']."-".urls_amigables($nom_tour).".php"; ?>" class="boton"><?php echo BOTONVERTOUR; ?></a>
...
<script src="<?php echo $pathHost; ?>js/jquery.flexslider-min.js"></script>
...
<?php
mysql_free_result($Utours);
mysql_free_result($querySliders);
?>