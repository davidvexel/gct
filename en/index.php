...
<h3 class="nomTour"><a class="ax" href="<?php echo $path; ?>en/detalles/<?php echo $row_Utours['id_tour']."-".urls_amigables($nom_tour).".php"; ?>"><? echo $row_Utours['nom_tour'.$idiomaDB]; ?></a></h3>
